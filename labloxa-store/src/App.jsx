...
const Navigation = ({ activeTab, setActiveTab }) => {
  return (
    <nav className="fixed top-0 w-full p-8 flex justify-between items-center z-[60] mix-blend-difference text-[#E5E0D0]">
      ...
      {/* Корзина */}
      <button className="flex items-center gap-3 border border-[#D4AF37]/30 px-6 py-2 rounded-sm hover:bg-[#D4AF37] hover:text-black transition-all duration-700 group">
